...
struct ProcessTabInfo {
    ...
    int lastDataIdx;   // last processed DataBuffer index (for top-5 PID filtering)
};
...
struct MainWindowState {
    ...
    HFONT hNetComboBoldFont;   // 网卡下拉框已连接加粗绿色字体
    HFONT hNetComboNormalFont; // 网卡下拉框普通字体
...
void RebuildProcessTabs(MainWindowState* s, const wchar_t* selectName = nullptr);
